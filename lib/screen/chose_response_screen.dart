        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rule2Screen()));
              },
              child: const Text(
                'Rule 2',
              ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rule3Screen()));
              },
              child: const Text(
                'Rule 3',
              ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rule4Screen()));
              },
              child: const Text(
                'Rule 4',
              ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rule5Screen()));
              },
              child: const Text(
                'Rule 5',
              ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rule6Screen()));
              },
              child: const Text(
                'Rule 6',
              ),
